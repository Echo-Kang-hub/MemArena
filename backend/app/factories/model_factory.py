        ...
        try:
            ...
            if self.provider == ProviderType.api:
                ...
                write_audit_event(
                    "llm_generate",
                    {
                        ...
                        "system_prompt_preview": str(system_prompt or "")[:160],
                        "prompt_preview": prompt[:200],
                        "response_preview": str(data.get("choices", [{}])[0].get("message", {}).get("content", ""))[:200],
                    },
                )
            ...
            write_audit_event(
                "llm_generate",
                {
                    ...
                    "system_prompt_preview": str(system_prompt or "")[:160],
                    "prompt_preview": prompt[:200],
                    "response_preview": f"[local:{self.model}] {prompt[:200]}",
